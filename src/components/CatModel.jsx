...
export default function CatModel({ cat, open, onClose }) {
    ...
    return (
        ...
        >
            ...
            {/* modal box */}
            <div className="relative bg-white dark:bg-surface rounded-2xl shadow-2xl max-w-3xl w-full mx-4 overflow-hidden z-10">
                <button
                    onClick={onClose}
                    aria-label="Stäng"
                ...
                <div className="md:flex">
                    ...
                    <div className="p-6 md:w-1/2">
                        ...
                        <div className="mb-4 p-3 bg-slate-50 rounded-lg">
                            <p className="text-lg font-bold text-rose-500">299 SEK</p>
                            <p className="text-xs text-slate-500">Adoptionsavgift</p>
                        </div>
